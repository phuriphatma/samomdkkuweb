...
| `npm run docs:dev` | The documentation site (`docs/`) with live reload. Published at **https://samo.md.kku.ac.th/docs** (the VM rebuilds it from `main` every 10 min), and mirrored to https://phuriphatma.github.io/samomdkkuweb/ as a backup |
