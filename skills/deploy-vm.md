...
**Run tally: 15 runs, 11 completed the docs step, 4 did not.**
...
everything. 1 on 2026-09-02: 31 s, docs published, roots 16 s apart. ⚠️ Four clean runs still prove nothing about the fifth.) The count only grows — a run that works is not evidence, and this
