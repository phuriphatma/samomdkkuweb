...
**Run tally: 16 runs, 12 completed the docs step, 4 did not.**
...
everything. 2 on 2026-09-02: both 31 s, docs published, roots 16 s apart. ⚠️ Four clean runs still prove nothing about the fifth.) The count only grows — a run that works is not evidence, and this
