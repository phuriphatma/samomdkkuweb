...
**Run tally: 20 runs, 16 completed the docs step, 4 did not.**
...
everything. 6 on 2026-09-02: all ~31 s, docs published, roots ~17 s apart. ⚠️ Four clean runs still prove nothing about the fifth.) The count only grows — a run that works is not evidence, and this
