...
export const PENDING = [
  ...
  },
  {
    ...
    area: 'house',
    audience: 'staff',
    text: 'ชั้นปีไม่เลื่อนเองทุกเดือนสิงหาคมอีกแล้ว — ผู้ดูแลกดเลื่อนเองปีละครั้ง '
      + 'เมื่อขึ้นปีการศึกษาใหม่ แล้วทุกคนเลื่อนพร้อมกัน '
      + 'ใครลาพักหรือเรียนซ้ำ เลือกชั้นปีที่ถูกไว้ครั้งเดียว ระบบจำส่วนต่างไว้ให้ '
      + 'ไม่ต้องไล่แก้รายคน และหน้าจัดการจะขึ้นเตือนเมื่อถึงกำหนดเลื่อน',
  },
  {
    type: 'improved',
    area: 'house',
    audience: 'staff',
    text: 'ระบบบ้าน: เห็นแล้วว่ามีใครตรวจข้อมูลตัวเองไปแล้วกี่คน เหลือกี่คน '
      + 'และกรองดูรายชื่อเฉพาะคนที่ยังไม่ได้ตรวจได้ '
      + 'นับให้ทั้งคนที่กดยืนยัน และคนที่แก้ข้อมูลของตัวเอง '
      + 'และดูเป็นรายชื่อได้เลยว่าใครตรวจแล้ว ใครยังไม่ตรวจ '
      + 'รวมทุกคนที่ระบบรู้จัก ทั้งสมาชิกทีม SAMO และนักศึกษาที่นำเข้ามาแล้ว',
  },
  {
    type: 'improved',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: ชั้นปีขึ้นให้อัตโนมัติจากรหัสนักศึกษาตอนเพิ่ม/แก้ไขสมาชิก '
      + 'และเอาปุ่ม “ดึงจากระบบบ้าน” ออกแล้ว เพราะทีม SAMO กับระบบบ้าน '
      + 'ใช้ข้อมูลชุดเดียวกันอยู่แล้ว ไม่มีอะไรให้ดึงข้ามระบบอีก '
      + 'ใช้ช่องค้นหาด้านบนฟอร์มแทนได้เลย',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: แก้ปัญหารูปประจำตัวหายไปเอง — เมื่อก่อนถ้าลบสมาชิกที่มีรูป '
      + 'ระบบอาจลบไฟล์รูปทิ้งทั้งที่หน้าอื่นยังใช้รูปนั้นอยู่ ทำให้รูปกลายเป็นรูปเสีย '
      + 'ตอนนี้ตรวจครบทุกที่ก่อนลบ และถ้าตรวจไม่ได้จะเก็บไฟล์ไว้เสมอ',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: กดปุ่มบันทึกสมาชิกซ้ำเร็วๆ ไม่ทำให้เกิดสมาชิกซ้ำอีกแล้ว',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: ปุ่ม “เพิ่มสมาชิก” กดแล้วไม่ขึ้นอะไรเลย และช่อง “ค้นหาคนจากระบบ” '
      + 'พิมพ์แล้วไม่ขึ้นรายชื่อ — ตอนนี้ใช้งานได้ตามปกติทั้งคู่ '
      + 'พิมพ์ชื่อ ชื่อเล่น รหัสนักศึกษา สาขา หรือ kkumail อย่างน้อย 2 ตัวอักษร '
      + 'แล้วเลือกจากรายการ ระบบจะเติมข้อมูลให้เอง ไม่ต้องพิมพ์ใหม่ทุกช่อง',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: กล่องยืนยัน “แน่ใจหรือไม่” เป็นหน้าต่างของระบบเองแล้ว '
      + 'เมื่อก่อนถ้าเบราว์เซอร์เคยขึ้นข้อความ “ไม่ให้หน้านี้แสดงกล่องโต้ตอบอีก” '
      + 'ปุ่มลบตำแหน่ง ลบสมาชิก ลบสาขา เผยแพร่ปี และแม้แต่ปุ่มบันทึกสิทธิ์ '
      + 'จะกดแล้วไม่เกิดอะไรขึ้นเลยและไม่มีข้อความบอก ตอนนี้ใช้งานได้เสมอทุกเครื่อง',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'staff',
    text: 'ทีม SAMO: หน้าจัดการรายการสาขาใช้งานบนมือถือได้แล้ว '
      + 'เมื่อก่อนปุ่มลบอยู่นอกกรอบหน้าต่างจนกดไม่ได้บนโทรศัพท์ '
      + 'และการเปลี่ยนชื่อสาขาตอนนี้พิมพ์ในบรรทัดนั้นได้เลย ไม่ต้องผ่านกล่องเด้ง',
  },
];
