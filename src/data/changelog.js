...
export const PENDING = [
  { type: 'new', area: 'team', audience: 'public',
    text: 'หน้าทีม SAMO มีมุมมองใหม่ “ผังองค์กร” เป็นแผนผังแบบกล่องต่อกันลงมา '
    + 'เลื่อนและซูมได้เหมือนแผนที่ เปิดมาจะเห็นตั้งแต่ฝ่ายลงไปถึงหัวหน้าแต่ละฝ่ายก่อน '
    + 'แล้วกดตัวเลขใต้กล่องเพื่อดูคนข้างในต่อได้ '
    + 'หรือเลือกเองว่าจะให้แสดงลึกแค่ไหน', },
