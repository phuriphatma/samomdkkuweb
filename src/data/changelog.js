...
export const PENDING = [
  ...
  { type: 'improved', area: 'team', audience: 'staff',
    text: 'หน้าจัดการทีม SAMO แยกระดับของฝ่ายให้เห็นชัดขึ้น ฝ่ายหลักแต่ละฝ่ายมีสีประจำฝ่ายของตัวเอง '
    + 'และเส้นนำสายตาทางซ้ายก็เป็นสีเดียวกันทั้งสาย เลื่อนลงไปลึกแค่ไหนก็ยังรู้ว่ากำลังอยู่ในฝ่ายไหน '
    + 'ฝ่ายที่อยู่ลึกกว่าจะจางลงตามลำดับ และตอนนี้เลือกได้แค่ “ฝ่าย” กับ “ตำแหน่ง” ไม่มี “แผนก” แล้ว '
