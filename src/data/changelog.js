...
export const PENDING = [
  ...
  },
  {
    ...
    area: 'house',
    audience: 'staff',
    text: 'ระบบบ้าน: เพิ่มอาจารย์ใหม่ได้จากในหน้าสายรหัสเลย กรอกชื่อ อีเมล ภาควิชา '
      + 'แล้วระบบใส่เข้าสายนั้นให้ทันที ไม่ต้องสลับไปแท็บอาจารย์แล้วกลับมาหาสายเดิมอีก '
      + 'และไม่ต้องกรอกคำนำหน้าแยกแล้ว พิมพ์รวมมากับชื่อได้เลย',
  },
  {
    type: 'improved',
    area: 'house',
