...
export const PENDING = [
  { type: 'improved', area: 'account', audience: 'public',
    text: 'หน้าเข้าสู่ระบบออกแบบใหม่ให้เข้าใจง่ายขึ้น '
    + 'ปุ่มเข้าสู่ระบบด้วย Google บอกชัดแล้วว่าใช้ได้กับทุกบัญชี Google '
    + 'ทั้ง Gmail ทั่วไปและอีเมล มข. เมื่อก่อนตัวหนาที่อีเมล มข. '
    + 'ทำให้หลายคนเข้าใจว่าต้องเป็นคน มข. เท่านั้น '
    + 'ส่วนการเข้าใช้แบบไม่เปิดเผยตัวตนตอนนี้อยู่รวมกันเป็นกล่องเดียว '
    + 'สลับระหว่างเข้าสู่ระบบกับสร้างบัญชีใหม่ได้ในที่เดียว '
