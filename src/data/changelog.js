...
export const PENDING = [
  ...
  { type: 'improved', area: 'team', audience: 'public',
    text: 'ในหน้าทีม SAMO ทุกมุมมอง ตำแหน่งของฝ่ายจะเรียงขึ้นก่อนฝ่ายย่อยเสมอ '
    + 'เปิดฝ่ายไหนก็เห็นหัวหน้าและคนในฝ่ายนั้นก่อน แล้วค่อยเป็นฝ่ายย่อยที่อยู่ข้างใน '
    + 'เมื่อก่อนสองอย่างนี้ปนกัน ทำให้ต้องไล่หาว่าใครอยู่ฝ่ายไหน', },
