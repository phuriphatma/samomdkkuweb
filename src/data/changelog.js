...
export const PENDING = [
  {
    ...
    area: 'house',
    audience: 'public',
    text: 'ชั้นปีตรงกันทุกหน้าแล้ว เมื่อก่อนหน้าแรก ระบบบ้าน และทีม SAMO '
      + 'อาจขึ้นชั้นปีคนละอย่างสำหรับคนเดียวกัน เพราะบางหน้าจำตัวเลขที่เคยกรอกไว้ '
      + 'ส่วนบางหน้าคำนวณให้ใหม่ ตอนนี้ทุกหน้าคำนวณจากรหัสนักศึกษาเหมือนกันหมด '
      + 'และเลื่อนชั้นปีให้เองทุกปีการศึกษา ไม่ต้องมีใครมาไล่แก้ทีละคน',
  },
  {
    type: 'fixed',
    area: 'team',
    audience: 'public',
    text: 'แก้ชั้นปีในหน้า “ข้อมูลของฉัน” แล้วไม่บันทึก — กดบันทึกแล้วค่าเดิมกลับมาเหมือนไม่ได้กด '
      + 'ตอนนี้บันทึกได้จริง และช่องชั้นปีเปลี่ยนเป็นแบบใหม่ที่จำ “ส่วนต่าง” ไว้ให้ '
      + 'เช่น ถ้าลาพักหรือเรียนซ้ำแล้วตั้งไว้ว่าช้ากว่ารุ่นหนึ่งปี ระบบจะจำไว้ตลอด '
      + 'ไม่ต้องกลับมาตั้งใหม่ทุกปี',
  },
  {
    type: 'improved',
    area: 'house',
    audience: 'public',
    text: 'แก้รหัสนักศึกษาแล้วทั้งรุ่นและชั้นปีเปลี่ยนตามทันที เมื่อก่อนรุ่นเปลี่ยนแต่ชั้นปีค้างอยู่ที่เดิม',
  },
  {
    type: 'improved',
    area: 'house',
    audience: 'public',
    text: 'หน้าแรกสั้นลง — รายชื่ออาจารย์ในบ้านเดียวกันพับเก็บไว้ กดเปิดดูได้เมื่อต้องการ '
      + 'ส่วนอาจารย์ที่ปรึกษาสายของเราแสดงไว้เหมือนเดิมเพราะเป็นข้อมูลที่คนเปิดมาหาบ่อยที่สุด '
      + 'คำขอแก้ไขของฉันก็เช่นกัน คำขอที่ยังรอผลและคำตอบล่าสุดยังเห็นทันที '
      + 'ที่เหลือพับเป็นประวัติไว้ด้านล่าง',
  },
  {
    type: 'improved',
    area: 'house',
    audience: 'staff',
    text: 'ระบบบ้าน: เพิ่มนักศึกษาที่มีอยู่ในระบบอยู่แล้ว เมื่อก่อนขึ้นข้อความผิดพลาดยาว ๆ '
      + 'เป็นภาษาอังกฤษที่อ่านไม่รู้เรื่อง ตอนนี้ระบบจะบอกตั้งแต่ตอนพิมพ์อีเมลว่า '
      + 'อีเมลนี้เป็นของใคร อยู่บ้านไหน และมีปุ่มกดไปแก้ข้อมูลคนนั้นได้เลย '
      + 'ถ้าเป็นคนที่อยู่ในทีม SAMO อยู่แล้วแต่ยังไม่มีในระบบบ้าน จะบอกว่าบันทึกได้เลย '
      + 'พร้อมปุ่มดึงชื่อ รหัส และสาขาที่ระบบมีอยู่มาใส่ให้ และบอกด้วยว่าช่องไหนไม่ตรงกัน',
  },
  {
    type: 'new',
    area: 'house',
  ...
  },
  {
    ...
    area: 'team',
    audience: 'public',
    text: 'เปลี่ยนรูปหรือนำรูปตัวเองออกจากหน้า “ข้อมูลของฉัน” แล้ว รูปเดิมจะถูกลบทิ้งจริง ๆ '
      + 'เมื่อก่อนรูปใหม่ขึ้นถูกต้อง แต่รูปเก่ายังค้างอยู่ในคลังไฟล์และยังเปิดดูได้อยู่ '
      + 'ตอนนี้ระบบตรวจก่อนว่าไม่มีที่ไหนใช้รูปนั้นแล้วจึงลบ '
      + '(ใช้กับรูปโลโก้บ้านและรูปสินค้าในร้านค้าด้วย)',
  },
  {
    type: 'fixed',
    area: 'platform',
    audience: 'public',
    text: 'รูปที่ลบออกจากระบบ จะดูไม่ได้อีกทันที '
      + 'เมื่อก่อนไฟล์ที่ลบยังเปิดดูได้อยู่ถ้ามีลิงก์ ตอนนี้ระบบตัดสิทธิ์การเข้าถึงก่อนลบเสมอ',
  },
  {
    type: 'fixed',
    area: 'news',
    audience: 'staff',
    text: 'ประกาศ: เปลี่ยนรูปปกหรือลบรูปในเนื้อหาแล้ว ไฟล์เดิมจะถูกลบทิ้งจริง ๆ '
      + 'และเมื่อลบประกาศ รูปทั้งหมดของประกาศนั้นจะถูกลบตามไปด้วย '
      + 'ยกเว้นรูปที่ประกาศอื่นยังใช้อยู่ ระบบจะเก็บไว้ให้',
  },
  {
    type: 'fixed',
    area: 'house',
    audience: 'staff',
    text: 'ระบบบ้าน: ตอนกดลบนักศึกษา ระบบจะบอกให้ชัดว่าจะลบอะไรบ้าง '
      + 'ถ้าคนนั้นอยู่ในทีม SAMO ด้วย จะบอกว่าอยู่ฝ่ายไหนและตำแหน่งกับรูปในทีม SAMO จะไม่ถูกลบ '
      + 'แต่ถ้าไม่ได้อยู่ในทีม SAMO และยังไม่เคยเข้าสู่ระบบ จะเตือนว่าข้อมูลตัวตนจะหายทั้งหมด '
      + 'และบอกจำนวนคำขอแก้ไขที่จะถูกลบไปด้วย',
  },
  {
    type: 'new',
    area: 'portal',
    audience: 'public',
    text: 'บอกให้ชัดว่าจะถามใครเวลามีปัญหา — ในการ์ด “ข้อมูลของฉัน” และหน้าแรกของ Admin '
      + 'เขียนไว้แล้วว่า ถ้าสิทธิ์หรือตำแหน่งที่ได้รับไม่ถูกต้อง ให้ติดต่ออุปนายกฝ่ายของท่าน '
      + 'หรือผู้ที่มีสิทธิ์แก้ไขทีม SAMO และดูได้ว่าใครมีสิทธิ์อะไรในองค์กรที่หน้าทีม SAMO '
      + 'ส่วนปัญหาเว็บหรือบัค แจ้งได้ที่แท็บแจ้งปัญหา (VitalSound) '
      + 'มีลิงก์อยู่ท้ายเว็บทุกหน้าและในการ์ดข้อมูลของฉัน '
      + 'สมาชิกทีม SAMO แจ้งใน Discord ช่อง #report-ปัญหาเว็บสโม ได้อีกทางหนึ่ง',
  },
];
