# STATE archive — 2026-06-06 (pre-/clear slim)

Stable, applied work pruned out of STATE.md to keep it under the ~200-line
cap. All of this is shipped to `main` and applied in prod; kept here as a
snapshot. `git log` carries the authoritative per-change history.
