...
- `deploy-hosting.md` *(20)* — Deploy, nginx & caching. Open when: deploy.sh, nginx, cache headers.
- `tooling-proofs.md` *(39)* — Proof scripts & verification discipline. Open when: writing or trusting a `tools/*.mjs` proof.
