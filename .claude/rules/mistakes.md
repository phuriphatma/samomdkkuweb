...
- `deploy-hosting.md` *(21)* — Deploy, nginx & caching. Open when: deploy.sh, nginx, cache headers.
- `tooling-proofs.md` *(40)* — Proof scripts & verification discipline. Open when: writing or trusting a `tools/*.mjs` proof.
