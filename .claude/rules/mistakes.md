...
- `authz-grants.md` *(16)* — The permission / seat / scope channel. Open when: adding an access channel, a scope, or a seat.
...
- `deploy-hosting.md` *(11)* — Deploy, nginx & caching. Open when: deploy.sh, nginx, cache headers.
- `tooling-proofs.md` *(29)* — Proof scripts & verification discipline. Open when: writing or trusting a `tools/*.mjs` proof.
