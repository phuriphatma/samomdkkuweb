...
- ✅ **DEPLOYED = `2fd34c0` (2026-09-04)** — **the passport MERGE is live.** One
  ...
  `/var/www/samo-web/passport` does NOT exist — the publish `--exclude` holds up the nginx rule that depends on its absence. Previous: `846488a`, `29df268`.
