...
- ✅ **DEPLOYED = `3a522c8` (2026-09-04)** — **the passport MERGE is live.** One
  ...
  `/var/www/samo-web/passport` does NOT exist — the publish `--exclude` holds up the nginx rule that depends on its absence. Previous: `8ca74a9`, `7f91ce4`.
