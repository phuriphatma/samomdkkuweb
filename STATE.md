...
- ✅ **DEPLOYED = `6624738` (2026-09-04)** — **the passport MERGE is live.** One
  ...
  `/var/www/samo-web/passport` does NOT exist — the publish `--exclude` holds up the nginx rule that depends on its absence. Previous: `7d613d1`, `8453ea4`.
...
- **Migrations through 0180. ALL 31 LIVE PROOFS GREEN**, whole suite re-run
